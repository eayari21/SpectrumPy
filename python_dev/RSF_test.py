...
if __name__ == "__main__": 
    ...
    vel_vals = np.array([elements['10% Velocity (km/s)'][0], elements['50% Velocity (km/s)'][0], elements['90% Velocity (km/s)'][0]])
    prob_vals = np.array([.1, .5, .9])
    ...
    ax.set_title("Hydrogen Appearance Probability vs. Velocity", fontweight = 'bold')
